...
namespace MMCar_Finder
{
    ...
    /// </summary>
    public class CaptureDeviceAvicap32
    {
        ...
        private CaptureDeviceAvicap32(ushort deviceNumber, string name, string description)
        {
        ...
        public static List<CaptureDeviceAvicap32> GetDevices()
        {
            List<CaptureDeviceAvicap32> devices = new List<CaptureDeviceAvicap32>();
            ...
            for (ushort i = 0; i < MAX_DEVICES; ++i)
            {
                ...
                {
                    devices.Add(new CaptureDeviceAvicap32(i, name.ToString(), description.ToString()));
                }
            }
