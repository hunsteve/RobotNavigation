...
namespace OnlabNeuralis
{
    public struct CarModelInput
    {
        ...
        public static explicit operator double[](CarModelInput ci)
        {
            return new double[] { ci.LeftSpeed, ci.RightSpeed };
        }

        public CarModelInput(double[] arg)
        {
            this.leftspeed = 0;
            this.rightspeed = 0;
        ...
        public CarModelInput(double leftspeed, double rightspeed)
        {
            this.leftspeed = 0;
            this.rightspeed = 0;
        ...
        public CarModelInput(double angle)
        {
            this.leftspeed = 0;
            this.rightspeed = 0;
            this.Angle = angle;            
